package com.agreent.openbuild.security;

import com.agreent.openbuild.security.oauth2.AudienceValidator;
import com.agreent.openbuild.security.oauth2.JwtGrantedAuthorityConverter;
...
public class WebSecurityConfig {
  ...
  private Consumer<OAuth2AuthorizationRequest.Builder> authorizationRequestCustomizer() {
    return customizer ->
      customizer.authorizationRequestUri(uriBuilder -> uriBuilder.queryParam("audience", "account").build());
  }
  ...
  private ReactiveJwtDecoder createJwtDecoder(String issuerUri, String jwkSetUri, String userInfoUri) {
    ...
    OAuth2TokenValidator<Jwt> audienceValidator = new AudienceValidator(Collections.singletonList("account"));
