...
import com.agreent.openbuild.core.config.replay.ReplayMarkerAwareTrackingEventProcessorBuilder;
...
public class AxonConfig {
  ...
  @Autowired
  public void configure(TaskExecutor taskExecutor, EventProcessingModule eventProcessingModule) {
  ...
  @Bean
  public CryptoShreddingSerializer eventSerializer(
    ...
    return new CryptoShreddingSerializer(
      JacksonSerializer.defaultSerializer(),
      cryptoShreddingKeyService,
      aesEncrypterDecrypterFactory,
      objectMapper,
      defaultValueProvider,
      keyIdentifierToStringConverter);
  }
  ...
  public XStream xStream() {
    ...
    xStream.allowTypesByWildcard(new String[]{"com.agreent.openbuild.**", "java.util.**"});
    return xStream;
  }

  @Bean
  public SagaStore globalSagaStore(
  ...
  public TokenStore tokenStore(
    EntityManagerProvider entityManagerProvider, Serializer defaultSerializer) {
