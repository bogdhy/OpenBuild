...
public class ReplayMarkerAwareTrackingEventProcessorBuilder implements EventProcessorBuilder {
  ...
  public ReplayMarkerAwareTrackingEventProcessorBuilder(
    TaskExecutor taskExecutor, EventProcessingModule eventProcessingModule) {
  ...
  public EventProcessor build(
    String name, Configuration configuration, EventHandlerInvoker eventHandlerInvoker) {
    var trackingEventProcessorConfiguration =
